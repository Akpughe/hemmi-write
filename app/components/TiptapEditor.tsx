  ...
  return (
    <div className="flex items-center gap-1 p-2 border-b border-border bg-background sticky top-0 z-10 flex-wrap">
      ...
      <button
        ...
        className="p-2 rounded hover:bg-muted transition-colors text-foreground disabled:opacity-40 disabled:cursor-not-allowed"
        title="Undo"
      >
...
export default function TiptapEditor() {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-lg dark:prose-invert max-w-none focus:outline-none min-h-screen px-12 py-8 font-[family-name:var(--font-lora)] text-foreground',
      },
    },
