        ...
        {documentTypes.map((type) => {
          ...
          return (
            <button
              ...
              className="p-6 border-2 border-border rounded-lg hover:border-blue-500 hover:bg-blue-500/10 transition-all text-left group"
            >
              <div className="flex items-start gap-4">
                <div className="text-4xl">{config.icon}</div>
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400 mb-1">
                    {config.label}
                  </h3>
                  ...
                  <div className="space-y-1 text-xs text-muted-foreground">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 bg-muted rounded">{config.citationStyle}</span>
                    </div>
                    <div className="flex items-center gap-2">
